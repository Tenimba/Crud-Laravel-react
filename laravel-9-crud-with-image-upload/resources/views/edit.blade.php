...
<div class="container mt-2">
  ...
  @endif
    ...
    <form action="{{ route('posts',$post->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="firstname" value="{{ $post->firstname }}" class="form-control" placeholder="firstname">
                    @error('firstname')
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="lastname" value="{{ $post->lastname }}" class="form-control" placeholder="lastname">
                    @error('lastname')
                      <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
